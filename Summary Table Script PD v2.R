...
# This script is designed to reformat PD (Pairwise Discrimination) raw data files for usage in split-plot ANOVA. The initial functions of this script filter the data into the respective genotypes and convert the data organization.
